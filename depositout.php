...
//PRZELEWY
    if(isset($_POST['lokata2'])) {
        //FLAGA
        $poprawnosc = true;
        //Sprawdzenie poprawności kwoty
        $lokata2 = $_POST['lokata2'];
        ...
        try {
            ...
            if($polaczenie->connect_errno!=0) {
                ...
                if($lokata2 > $_SESSION['lokata']) {
                  $poprawnosc = false;
                  $_SESSION['e_lokata2'] = 'Nie masz wystarczającej ilości środków na lokacie!';
                }
                ...
                if($poprawnosc == true) {
                  try {
                      ...
                      if($polaczenie->connect_errno!=0) {
                          ...
                          if($polaczenie->query("CALL WyplacLokata(".$_SESSION['id'].",$lokata2)")) {
                              $_SESSION['udanalokata2'] = true;
                              header('Location: ulokata2.php');
                          } else {
        ...
        <!-- WYSUWANE OKNA -->
            ...
            <section class="bank-deposit wrapper" style="display:block">
               ...
               <form method="POST" action="depositout.php">
                  ...
                  <?php
                      if(isset($_SESSION['e_lokata2'])) {
                          echo '<p class="error">'.$_SESSION['e_lokata2'].'</p>';
                          unset($_SESSION['e_lokata2']);
                      }
                  ?>
