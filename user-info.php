    ...
    <body>
        ...
        <main class="main-content wrapper">
          <!-- WYSUWANE OKNA -->
              ...
              <section class="bank-transfer wrapper">
                  <form class="transfer-form" method="POST" action="accountp.php">
                      ...
                      <label class="clearfix">Numer rachunku&#58;<input class="transfer-input" type="number" name="numer-rachunku" placeholder="00 0000 0000 0000 0000 0000 0000" required></label>
            ...
            <table class="personal-info">
              <?php
                  echo '<p class="user-names">'.$_SESSION['imie'].' '.$_SESSION['nazwisko'].'</p>';
                  echo '<tr><th>Data urodzenia:</th><td>'.$_SESSION['durodzenia'].'</td></tr>';
                  echo '<tr><th>Pesel:</th><td>'.$_SESSION['pesel'].'</td></tr>';
                  echo '<tr><th>Numer telefonu:</th><td>'.$_SESSION['telefon'].'</td></tr>';
                  echo '<tr><th>Adres e-mail:</th><td>'.$_SESSION['mail'].'</td></tr>';
                  echo '<tr><th>Adres zamieszkania:</th><td rowspan="2">'.$_SESSION['miejscowosc'].'</br>ul. '.$_SESSION['ulica'].' '.$_SESSION['budynek'].'/'.$_SESSION['lokal'].'</td></tr>';
              ?>
            </table>
            <p class="info">Aby zmienić swoje dane osobowe, skontaktuj się z administratorem.</p>
        </main>
        <!-- STOPKA STRONY -->
